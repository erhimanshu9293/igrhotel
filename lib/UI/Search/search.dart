...
import 'package:booking_hotel_firebase/UI/Search/searchBoxEmpty.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  AppLocalizations.of(context).tr('wouldSearch'),
                  style: TextStyle(
                      letterSpacing: 0.1,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              AppLocalizations.of(context).tr('noMatching'),
              style: TextStyle(
                  fontWeight: FontWeight.w400,
                  fontSize: 17.5,
