...
import 'package:booking_hotel_firebase/UI/B1_Home/Hotel/Hotel_Detail_Concept_2/ratting.dart';
                  ...
                  builder: (
                    ...
                    if (!snapshot.hasData) {
                      return Center(
                        ...
                        Text(
                          AppLocalizations.of(context).tr('notHaveReview'),
                          style: TextStyle(
                              fontFamily: "Sofia",
                      ...
                      if (snapshot.data.documents.isEmpty) {
                        ...
                        return ratingCard(
                            userId: "", list: snapshot.data.documents);
                      }
                    }
                  }),
              SizedBox(
