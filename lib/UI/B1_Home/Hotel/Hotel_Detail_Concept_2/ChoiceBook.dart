...
class ChoiceBook extends StatefulWidget {
  final String imageD,
      titleD,
      locationD,
      idD,
  ...
  @override
  _ChoiceBookState createState() => _ChoiceBookState();
}

class _ChoiceBookState extends State<ChoiceBook> {
  ...
  String _nama, _photoProfile, _email, _rooms;
    ...
    void addDataBooking() {
      FirebaseFirestore.instance
        ...
        FirebaseFirestore.instance
          ...
          "Rooms": _rooms + " Rooms",
          "Title": widget.titleD,
          "Room Name": "Destination " + widget.titleD,
          "Information Room": "Destination " + widget.locationD,
          "Price Room": "\$100",
        });
      });
    }
