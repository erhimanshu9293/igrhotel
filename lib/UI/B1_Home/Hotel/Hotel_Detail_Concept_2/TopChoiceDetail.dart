...
import 'package:booking_hotel_firebase/UI/B1_Home/Hotel/Hotel_Detail_Concept_2/Gallery.dart';
...
import 'ChoiceBook.dart';
import 'SeeAll/questionSeeAll.dart';
import 'SeeAll/reviewSeeAll.dart';
import 'maps.dart';

class TopChoiceDetail extends StatefulWidget {
  ...
  @override
  _TopChoiceDetailState createState() => _TopChoiceDetailState();
}

class _TopChoiceDetailState extends State<TopChoiceDetail> {
  _checkFirst() async {
                  ...
                  child: Column(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () async {
                          Navigator.of(context).push(PageRouteBuilder(
                              pageBuilder: (_, __, ___) => new ChoiceBook(
                                    userId: widget.userId,
