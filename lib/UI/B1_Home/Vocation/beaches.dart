...
class Beaches extends StatefulWidget {
  ...
  Beaches({this.title, this.userId});
    ...
    var _category = Column(
      ...
      children: <Widget>[
        ...
        CategoryIconValue(
          ...
          title1: AppLocalizations.of(context).tr('attraction'),
          tap2: onClickMenuIcon,
          icon2: "assets/image/icon/tour.png",
          title2: AppLocalizations.of(context).tr('tour'),
          tap3: onClickMenuIcon,
          icon3: "assets/image/icon/bag.png",
          title3: AppLocalizations.of(context).tr('travel'),
          tap4: onClickMenuIcon,
          icon4: "assets/image/icon/plant.png",
          title4: AppLocalizations.of(context).tr('spa'),
        ),
        Padding(padding: EdgeInsets.only(top: 23.0)),
        CategoryIconValue(
          icon1: "assets/image/icon/lamp.png",
          tap1: onClickMenuIcon,
          title1: AppLocalizations.of(context).tr('courses'),
          icon2: "assets/image/icon/sneaker.png",
          tap2: onClickMenuIcon,
          title2: AppLocalizations.of(context).tr('sports'),
          icon3: "assets/image/icon/playground.png",
          tap3: onClickMenuIcon,
          title3: AppLocalizations.of(context).tr('played'),
          icon4: "assets/image/icon/ticket.png",
          tap4: onClickMenuIcon,
          title4: AppLocalizations.of(context).tr('cinema'),
        ),
    ...
    var _recommended = Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            AppLocalizations.of(context).tr('hotelsAround'),
            style: TextStyle(
                fontFamily: "Sofia",
                fontSize: 20.0,
                fontWeight: FontWeight.w700),
        ...
        Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                .collection("hotel")
                .where('vacations', isEqualTo: 'beaches')
                .snapshots(),
