...
class Tropical extends StatefulWidget {
  ...
  Tropical({this.title, this.userId});

  @override
  _TropicalState createState() => _TropicalState();
}

class _TropicalState extends State<Tropical> {
  @override
    ...
    var _recommended = Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            AppLocalizations.of(context).tr('hotelInNewYork'),
            style: TextStyle(
                fontFamily: "Sofia",
                fontSize: 20.0,
