...
class Florida extends StatefulWidget {
  final String title, userId;
  Florida({this.title, this.userId});

  @override
  _FloridaState createState() => _FloridaState();
}

class _FloridaState extends State<Florida> {
  @override
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Container(
              ...
              child: Text(
                AppLocalizations.of(context).tr('floridaDesc'),
                style: TextStyle(
                    fontFamily: "Sofia",
        ...
        Container(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                .collection("discover")
                .where("location", isEqualTo: 'Florida')
                .snapshots(),
    ...
    var _recommended = Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            AppLocalizations.of(context).tr('hotelsInFlorida'),
            style: TextStyle(
                fontFamily: "Sofia",
                fontSize: 20.0,
                fontWeight: FontWeight.w700),
