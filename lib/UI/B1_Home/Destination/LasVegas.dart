...
class LasVegas extends StatefulWidget {
  final String title, userId;
  LasVegas({this.title, this.userId});

  @override
  _LasVegasState createState() => _LasVegasState();
}

class _LasVegasState extends State<LasVegas> {
  @override
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Container(
              ...
              child: Text(
                AppLocalizations.of(context).tr('vegasDesc'),
                style: TextStyle(
                    fontFamily: "Sofia",
        ...
        Container(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                .collection("discover")
                .where("location", isEqualTo: 'Las Vegas')
                .snapshots(),
    ...
    var _recommended = Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            AppLocalizations.of(context).tr('hotelInLasVegas'),
            style: TextStyle(
                fontFamily: "Sofia",
                fontSize: 20.0,
                fontWeight: FontWeight.w700),
